briefingRoom.mission.objectiveTimers[$OBJECTIVEINDEX$] = function()
  ...
  for __,u in ipairs(briefingRoom.mission.objectives[$OBJECTIVEINDEX$].unitNames) do
    ...
    if unit ~= nil then
      ...
      if distance < 500 and not unit:inAir() then -- less than 5nm away on the X/Z axis, less than 8000 feet of altitude difference
        briefingRoom.radioManager.play("$LANGPILOT$: Command, Cargo Delivered.", "RadioPilotCargoDelivered")
