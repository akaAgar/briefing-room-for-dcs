...
function GMFunc.DrawText(param1, param2, param3, param4, param5, param6, param7, mcoord)
  ...
  for i, param in pairs(paramTbl) do if param == "red" then coal = 1
...
function GMFunc.DrawArrow(param1, param2, param3, param4, param5, param6, param7, mcoord)
  ...
  for i, mark in pairs(allMarks) do if string.find(mark.text, "c") and tonumber(string.sub(mark.text, 2))
  ...
  then for i = 1, #corners, 1 do if corners[i] ~= nil
  ...
  then trigger.action.outText("Shape gezeichnet, coal = " ..
    coal ..
    " color = " ..
    color[1] ..
    "," ..
    ...
    "," ..
    fillColor[2] ..
    "," .. fillColor[3] .. " alpha = " .. alpha .. " fillAlpha = " .. fillAlpha .. " lineType = " .. lineType, 60)
  ...
  then if color[1] == fillColor[1] or color[2] == fillColor[2] or color[3] == fillColor[3]
    ...
    then trigger.action.outText("Textbox gezeichnet, x = " ..
      textPos.x ..
      " z = " ..
      textPos.z ..
      " y = " ..
      textPos.y ..
      " coal = " .. coal .. " alpha = " .. alpha .. " fillAlpha = " .. fillAlpha .. " shapeText = " .. shapeText, 60)
...
function GMFunc.DrawCircle(param1, param2, param3, param4, param5, param6, param7, mcoord)
  ...
  for i, mark in pairs(allMarks) do if mark.text == "rad"
...
function GMFunc.DrawRect(param1, param2, param3, param4, param5, param6, param7, mcoord)
  ...
  for i, mark in pairs(allMarks) do if mark.text == "c"
...
function GMFunc.DrawPoly(param1, param2, param3, param4, param5, param6, param7, mcoord)
  ...
  for i, mark in pairs(allMarks) do if string.find(mark.text, "c")
  ...
  if #polyCorners == 2 then trigger.action.markupToAll(7, coal, GMFunc.lastPolyID, mcoord, polyCorners[1], polyCorners[2
    ], color, fillColor, lineType, false)
  elseif #polyCorners == 3 then trigger.action.markupToAll(7, coal, GMFunc.lastPolyID, mcoord, polyCorners[1],
    polyCorners[2], polyCorners[3], color, fillColor, lineType, false)
  elseif #polyCorners == 4 then trigger.action.markupToAll(7, coal, GMFunc.lastPolyID, mcoord, polyCorners[1],
    polyCorners[2], polyCorners[3], polyCorners[4], color, fillColor, lineType, false)
  elseif #polyCorners == 5 then trigger.action.markupToAll(7, coal, GMFunc.lastPolyID, mcoord, polyCorners[1],
    polyCorners[2], polyCorners[3], polyCorners[4], polyCorners[5], color, fillColor, lineType, false)
  elseif #polyCorners == 6 then trigger.action.markupToAll(7, coal, GMFunc.lastPolyID, mcoord, polyCorners[1],
    polyCorners[2], polyCorners[3], polyCorners[4], polyCorners[5], polyCorners[6], color, fillColor, lineType, false)
  elseif #polyCorners == 7 then trigger.action.markupToAll(7, coal, GMFunc.lastPolyID, mcoord, polyCorners[1],
    polyCorners[2], polyCorners[3], polyCorners[4], polyCorners[5], polyCorners[6], polyCorners[7], color, fillColor,
    lineType, false)
  elseif #polyCorners == 8 then trigger.action.markupToAll(7, coal, GMFunc.lastPolyID, mcoord, polyCorners[1],
    polyCorners[2], polyCorners[3], polyCorners[4], polyCorners[5], polyCorners[6], polyCorners[7], polyCorners[8], color
    , fillColor, lineType, false)
  elseif #polyCorners == 9 then trigger.action.markupToAll(7, coal, GMFunc.lastPolyID, mcoord, polyCorners[1],
    polyCorners[2], polyCorners[3], polyCorners[4], polyCorners[5], polyCorners[6], polyCorners[7], polyCorners[8],
    polyCorners[9], color, fillColor, lineType, false)
  elseif #polyCorners == 10 then trigger.action.markupToAll(7, coal, GMFunc.lastPolyID, mcoord, polyCorners[1],
    polyCorners[2], polyCorners[3], polyCorners[4], polyCorners[5], polyCorners[6], polyCorners[7], polyCorners[8],
    polyCorners[9], polyCorners[10], color, fillColor, lineType, false)
  ...
  then local middlePoint = {}
    ...
    for i = 1, #polyCorners, 1 do middlePoint.x = middlePoint.x + polyCorners[i].x
...
function GMFunc.DeleteDrawing(param1, mcoord)
  ...
  for i, MarkPanel in pairs(allMarks) do local MarkCoord = COORDINATE:New(MarkPanel.pos.x, MarkPanel.pos.y,
      MarkPanel.pos.z)
...
function GMFunc.WhatsThis(param1, mcoord)
  ...
  for i, unit in pairs(queryTable) do local scanUName = unit:getName()
...
function GMFunc.ExplodeAtMark(param1, param2, param3, mcoord)
  ...
  then local expUnits = expGroup:GetUnits()
    ...
    for i, Victim in pairs(expUnits) do Victim:Explode(expYield, expDelay)
...
function GMFunc.ShowText(param1, param2, param3, param4)
  ...
  then local coalition = nil
    ...
    then trigger.action.outTextForCoalition(coalition, GMFunc.MsgBorderL .. param1 .. GMFunc.MsgBorderR, DispTime,
        clearView)
...
function GMFunc.Delete(param1, mcoord)
  ...
  then if param1 == nil
    ...
    for i, unit in pairs(deleteTable) do if unit:getPlayerName() == nil
...
function GMFunc.Spawn(param1, param2, param3, param4, param5, param6, param7, mcoord)
  ...
  if param2 == "ground" or param3 == "ground" or param4 == "ground" or param5 == "ground" or param6 == "ground" or
      param7 == "ground"
  ...
  if param2 == "cargo" or param3 == "cargo" or param4 == "cargo" or param5 == "cargo" or param6 == "cargo" or
      param7 == "cargo"
  ...
  if param2 == "free" or param3 == "free" or param4 == "free" or param5 == "free" or param6 == "free" or param7 == "free" then SetROE = ENUMS
      .ROE.WeaponFree
  elseif param2 == "hold" or param3 == "hold" or param4 == "hold" or param5 == "hold" or param6 == "hold" or
      param7 == "hold" then SetROE = ENUMS.ROE.WeaponHold
  elseif param2 == "return" or param3 == "return" or param4 == "return" or param5 == "return" or param6 == "return" or
      param7 == "return" then SetROE = ENUMS.ROE.ReturnFire
  end
...
function GMFunc.ObjectList(param1, param2, param3, mcoord)
  ...
  for i, param in pairs(paramTable) do if param == "msg" then msgOut = true end
  ...
  then local staSet = SET_STATIC:New()
    ...
    for i, param in pairs(paramTable) do if param ~= nil and param ~= "sta" and param ~= "msg" then staSet:
        FilterPrefixes(param) end
  ...
  then local cargoSet = SET_CARGO:New()
    ...
    for i, param in pairs(paramTable) do if param ~= nil and param ~= "cargo" and param ~= "msg" then cargoSet:
        FilterPrefixes(param) end
  ...
  then local groupSet = SET_GROUP:New()
    ...
    for i, param in pairs(paramTable) do if param == "helo" then groupSet:FilterCategoryHelicopter()
    ...
    for i, param in pairs(paramTable) do if param ~= nil and param ~= "msg"
...
function GMFunc.ShowCoord(mcoord)
  ...
  local CoordMarker = MARKER:New(mcoord,
    "LL: " .. LLString .. "\nLL Dec: " .. DecString .. "\nLL Prec: " .. PrecString .. "\nMGRS: " .. MGRSString)
...
function GMFunc.CallFunction(param1, param2, param3, param4, param5, param6, param7, mcoord)
  ...
  for i, param in pairs(paramTable) --check if any of the given parameters are references to global varsdo if _G[param]
        ~= nil
  ...
  then _G[firstIndex][sndIndex][trdIndex](paramTable.param2, paramTable.param3, paramTable.param4, paramTable.param5,
    paramTable.param6, paramTable.param7, mcoord)

  elseif firstIndex ~= nil and sndIndex ~= nil

  then _G[firstIndex][sndIndex](paramTable.param2, paramTable.param3, paramTable.param4, paramTable.param5,
    paramTable.param6, paramTable.param7, mcoord)

  elseif firstIndex ~= nil

  then _G[firstIndex](paramTable.param2, paramTable.param3, paramTable.param4, paramTable.param5, paramTable.param6,
    paramTable.param7, mcoord)
...
function GMFunc.CreateHomBeacon(param1, param2, param3, param4, param5, param6, mvec3)
  ...
  for i, param in pairs(paramTable) do if param == "noloop" then rLoop = false
...
function GMFunc.MarkHandler:onEvent(event)
  ...
  elseif event.id == 27 and string.find(event.text, GMFunc.CmdSymbol) and
      (GMFunc.PW == nil or string.find(event.text, GMFunc.PW) ~= nil)
  ...
  then if event.coalition == GMFunc.RestrToCoal or GMFunc.RestrToCoal == nil
    ...
    then local full = nil
      ...
      then local paramStart = string.find(full, GMFunc.CmdSymbol)
        ...
        while string.find(remString, GMFunc.CmdSymbol) do local paramInd = "param" .. paramNum
      ...
      then trigger.action.outText("Voller Text = " .. full, 10)
        ...
        for i, param in pairs(allParams) do trigger.action.outText(i .. " = " .. param, 10)
      ...
      then if GMFunc.DebugMode == true
        ...
        GMFunc.DrawArrow(allParams.param1, allParams.param2, allParams.param3, allParams.param4, allParams.param5,
          allParams.param6, allParams.param7, mcoord)
      ...
      then if GMFunc.DebugMode == true
        ...
        GMFunc.DrawCircle(allParams.param1, allParams.param2, allParams.param3, allParams.param4, allParams.param5,
          allParams.param6, allParams.param7, mcoord)
      ...
      then if GMFunc.DebugMode == true
        ...
        GMFunc.DrawRect(allParams.param1, allParams.param2, allParams.param3, allParams.param4, allParams.param5,
          allParams.param6, allParams.param7, mcoord)
      ...
      then if GMFunc.DebugMode == true
        ...
        GMFunc.DrawPoly(allParams.param1, allParams.param2, allParams.param3, allParams.param4, allParams.param5,
          allParams.param6, allParams.param7, mcoord)
      ...
      then if GMFunc.DebugMode == true
        ...
        GMFunc.DrawText(allParams.param1, allParams.param2, allParams.param3, allParams.param4, allParams.param5,
          allParams.param6, allParams.param7, mcoord)
      ...
      then if GMFunc.DebugMode == true
        ...
        GMFunc.Spawn(allParams.param1, allParams.param2, allParams.param3, allParams.param4, allParams.param5,
          allParams.param6, allParams.param7, mcoord)
      ...
      then if GMFunc.DebugMode == true
        ...
        GMFunc.CallFunction(allParams.param1, allParams.param2, allParams.param3, allParams.param4, allParams.param5,
          allParams.param6, allParams.param7, mcoord)
      ...
      then if GMFunc.DebugMode == true
        ...
        GMFunc.CreateHomBeacon(allParams.param1, allParams.param2, allParams.param3, allParams.param4, allParams.param5,
          allParams.param6, mvec3)
