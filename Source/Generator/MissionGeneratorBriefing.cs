...
namespace BriefingRoom4DCSWorld.Generator
{
    ...
    public class MissionGeneratorBriefing : IDisposable
    {
            ...
            List<UnitFlightGroupBriefingDescription> flightGroups, DBEntryTheaterAirbase airbaseDB)
        {
            ...
            briefing += $"This mission was generated by BriefingRoom for DCS {BriefingRoom.BRIEFINGROOM_VERSION}, a random mission generator for DCS World (github.com/akaAgar/briefing-room-for-dcs)";
