...
namespace BriefingRoom4DCSWorld.Generator
{
    ...
    public class MissionGeneratorSupportUnits : IDisposable
    {
        ...
        public UnitFlightGroupBriefingDescription[] CreateUnitGroups(DCSMission mission, DBEntryCoalition allyCoalitionDB)
        {
            ...
            briefingFGList.Add(AddSupportUnit(mission, allyCoalitionDB, SupportUnitRoles.TankerBasket));
            briefingFGList.Add(AddSupportUnit(mission, allyCoalitionDB, SupportUnitRoles.TankerBoom));
        ...
        private UnitFlightGroupBriefingDescription AddSupportUnit(DCSMission mission, DBEntryCoalition allyCoalitionDB, SupportUnitRoles supportRole)
        {
            ...
            return new UnitFlightGroupBriefingDescription(
                ...
                Database.Instance.GetEntry<DBEntryUnit>(unitType).AircraftData.GetRadioAsString());
        }
