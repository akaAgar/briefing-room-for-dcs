...
namespace BriefingRoom4DCSWorld.Generator
{
    ...
    public class MissionGeneratorSupportUnits : IDisposable
    {
        ...
        public UnitFlightGroupBriefingDescription[] CreateUnitGroups(DCSMission mission, DBEntryCoalition allyCoalitionDB)
        {
            ...
            //briefingFGList.Add(AddSupportUnit(mission, allyCoalitionDB, UnitFamily.PlaneTankerBasket, new Tacan(47,"TKR", 1134000000))); //TACAN choise due to https://forums.eagle.ru/topic/165047-hornet-mini-updates/page/6/?tab=comments#comment-3803291
            //briefingFGList.Add(AddSupportUnit(mission, allyCoalitionDB, UnitFamily.PlaneTankerBoom, new Tacan(48, "TKR", 1135000000)));
            //briefingFGList.Add(AddSupportUnit(mission, allyCoalitionDB, UnitFamily.PlaneAWACS)); // AWACS must be added last, so it its inserted first into the spawning queue
