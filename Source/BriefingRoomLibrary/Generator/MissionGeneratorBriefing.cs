...
namespace BriefingRoom.Generator
{
    ...
    public class MissionGeneratorBriefing : IDisposable
    {
            ...
            List<UnitFlightGroupBriefingDescription> flightGroups, DBEntryTheaterAirbase airbaseDB)
        {
            ...
            briefing += $"This mission was generated by BriefingRoom for DCS {Toolbox.BRIEFINGROOM_VERSION}, a random mission generator for DCS World ({BriefingRoom.WEBSITE_URL})";
