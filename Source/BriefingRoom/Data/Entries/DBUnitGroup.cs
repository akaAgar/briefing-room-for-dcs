...
//    /// </summary>
//    internal struct DBUnitGroup
//    {
//        /// <summary>
//        /// Unit category of this unit group, if any.
//        /// Null means group is empty/should not be spawned.
//        /// </summary>
//        internal UnitCategory? Category { get { return (Families.Length > 0) ? (UnitCategory?)Families[0].GetUnitCategory() : null; } }

//        /// <summary>
//        /// Min/max number of units in the group.
//        /// </summary>
//        internal MinMaxI Count { get; }

//        /// <summary>
//        /// Unit families this group may belong to.
//        /// </summary>
//        internal UnitFamily[] Families { get; }

//        /// <summary>
//        /// Special flags for this group.
//        /// </summary>
//        internal DBUnitGroupFlags Flags { get; }
...
//        internal DBUnitGroup(INIFile ini, string section)
//        {
...
//                Families = (from UnitFamily family in Families where family.GetUnitCategory() == family0.GetUnitCategory() select family).ToArray();
//            }
...
//                        BriefingRoom.PrintToLog($"File \"Include\\Lua\\Units\\{lGroup}.lua\" doesn't exist.", LogMessageErrorLevel.Warning);

//                if (!File.Exists($"{BRPaths.INCLUDE_LUA_UNITS}{LuaUnit}.lua"))
//                    BriefingRoom.PrintToLog($"File \"Include\\Lua\\Units\\{LuaUnit}.lua\" doesn't exist.", LogMessageErrorLevel.Warning);
//            }
//        }
//    }
//}
