...
//    /// </summary>
//    internal class MissionGeneratorExtensionsAndFeatures : IDisposable
//    {
//        /// <summary>
...
//        internal MissionGeneratorExtensionsAndFeatures(UnitMaker unitMaker)
//        {
//            UnitMaker = unitMaker;
//        }
...
//        internal void GenerateExtensionsAndFeatures(DCSMission mission, MissionTemplate template, DBEntryCoalition[] coalitionsDB)
//        {
//            int i, j;
...
//                    if (group == null)
//                        BriefingRoom.PrintToLog($"Failed to create mission feature unit group for objective #{i + 1} made of the following units: {string.Join(", ", units)}", 1, DebugLogMessageErrorLevel.Warning);
