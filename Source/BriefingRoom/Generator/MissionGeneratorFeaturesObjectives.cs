...
//                if (featureDB.UnitGroupFlags.Contains(MissionFeatureUnitGroupFlags.AlwaysOnMap)) groupFlags = UnitMakerGroupFlags.AlwaysHidden;
//                else if (featureDB.UnitGroupFlags.Contains(MissionFeatureUnitGroupFlags.NeverOnMap)) groupFlags = UnitMakerGroupFlags.NeverHidden;
...
//                GeneratorTools.ReplaceKey(ref featureLua, "GroupID", groupInfo.Value.GroupID);
