...
//        internal void GenerateMissionDate(DCSMission mission, MissionTemplate template, DBEntryCoalition[] coalitions)
//        {
//            int day, year;
//            Month month;
...
//            BriefingRoom.PrintToLog($"Misson date set to {mission.DateTime.ToDateString(false)}", 1);
//        }
...
//        internal void GenerateMissionTime(DCSMission mission, MissionTemplate template, DBEntryTheater theaterDB)
//        {
...
//            BriefingRoom.PrintToLog($"Starting time set to {mission.DateTime.ToTimeString()}", 1);
//        }
