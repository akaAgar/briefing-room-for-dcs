...
//    /// </summary>
//    internal class MissionGeneratorEnemySupportUnits : IDisposable
//    {
//        /// <summary>
...
//        internal MissionGeneratorEnemySupportUnits(UnitMaker unitMaker)
//        {
//            UnitMaker = unitMaker;
//        }
...
//        internal void CreateUnitGroups(DCSMission mission, MissionTemplate template, DBEntryCoalition enemyCoalitionDB, string[] unitMods)
//        {
...
//        {
//            BriefingRoom.PrintToLog($"Adding {unitFamily} enemy support unit...", 1);
...
//            {
//                BriefingRoom.PrintToLog($"No support unit found for this role in coalition \"{enemyCoalitionDB.ID}\"", 2);
