...
namespace BriefingRoom4DCS.Generator
{
    ...
    /// </summary>
    internal class MissionGeneratorCarrier : IDisposable
    {
        /// <summary>
        ...
        internal MissionGeneratorCarrier(/*UnitMaker unitMaker*/)
        {
            //UnitMaker = unitMaker;
        }
        ...
        /// <returns></returns>
        internal void GenerateCarriers(DCSMission mission, MissionTemplate template, DBEntryCoalition playerCoalitionDB)
        {
            List<string> carrierTypes = new List<string>();

            foreach (MissionTemplateFlightGroup flightGroup in template.PlayerFlightGroups)
            {
                //if (string.IsNullOrEmpty(flightGroup.Carrier)) // No carrier for this flight group
            }
