...
//        internal DBEntryTheaterAirbase SelectStartingAirbase(DCSMission mission, MissionTemplate template)
//        {
//            DBEntryTheaterAirbase[] theaterAirbases = Database.Instance.GetEntry<DBEntryTheater>(template.ContextTheater).GetAirbases();
...
//            airbasesList.Add((from DBEntryTheaterAirbase airbase in Database.Instance.GetAllEntries<DBEntryTheaterAirbase>()
//                              where Toolbox.StringICompare(airbase.Theater, template.ContextTheater) && airbase.ParkingSpots.Length >= requiredParkingSpots
...
//            if ((template.ContextTheaterCountriesCoalitions == CountryCoalition.Default) || (template.ContextTheaterCountriesCoalitions == CountryCoalition.Inverted))
//            {
//                Coalition requiredCoalition = template.ContextTheaterCountriesCoalitions == CountryCoalition.Inverted ? mission.CoalitionEnemy : mission.CoalitionPlayer;
...
//            {
//                airbasesList.Add((from DBEntryTheaterAirbase airbase in theaterAirbases
...
//        internal void SetupAirbasesCoalitions(DCSMission mission, CountryCoalition theaterAirbasesCoalitions)
//        {
//            DBEntryTheaterAirbase[] airbases =
//                (from DBEntryTheaterAirbase airbase in Database.Instance.GetAllEntries<DBEntryTheaterAirbase>()
//                 where Toolbox.StringICompare(mission.Theater, airbase.Theater)
//                 select airbase).ToArray();

//            mission.AirbasesCoalition.Clear();
//            foreach (DBEntryTheaterAirbase airbase in airbases)
//            {
//                // Airbase ID already exists in the mission
//                if (mission.AirbasesCoalition.ContainsKey(airbase.DCSID)) continue;

//                // Airbase is the player starting airbase, always set it to the player coalition
//                if (airbase.DCSID == mission.InitialAirbaseID)
//                {
//                    mission.AirbasesCoalition.Add(airbase.DCSID, mission.CoalitionPlayer);
//                    continue;
//                }

//                // Other airbases are assigned to a coalition according to the theater and the template settings
//                Coalition airbaseCoalition = airbase.Coalition;
...
//                mission.AirbasesCoalition.Add(airbase.DCSID, airbaseCoalition);
//            }
//        }
