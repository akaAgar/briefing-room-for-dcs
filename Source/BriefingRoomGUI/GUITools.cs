...
namespace BriefingRoom.GUI
{
    ...
    public static class GUITools
    {
        ...
        ///// </summary>
        //private const string EMBEDDED_RESOURCES_PATH = "BriefingRoom.Resources.";

        ///// <summary>
        ///// Returns an icon from an embedded resource.
        ///// </summary>
        ///// <param name="resourcePath">Relative path to the icon from BriefingRoom.Resources.</param>
        ...
        public static string GetDisplayName(Database database, Type valueType, object value)
        {
            GetDisplayStrings(database, valueType, value, out string displayName, out string _);
            return displayName;
        }

        public static string GetDisplayName<T>(Database database, T value)
        {
            return GetDisplayName(database, typeof(T), value);
        }

        public static void GetDisplayStrings(Database database, Type valueType, object value, out string displayName, out string description)
        {
            ...
            {
                DBEntry dbEntry = database.GetEntry(valueType, value.ToString());
