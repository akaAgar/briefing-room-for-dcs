...
{
    /// <summary>
    /// Stores information about a set of weather conditions in a <see cref="DBEntryTheater"/>.
    /// </summary>
    public struct DBEntryTheaterWeather
    {
        /// <summary>
        ...
        public DBEntryTheaterWeather(INIFile ini, string key)
        {
